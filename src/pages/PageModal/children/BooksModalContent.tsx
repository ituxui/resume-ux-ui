    ...
    <PageModal.Container>
      ...
      <PageModal.Content>
        <Section sublevel={1} className={Styles.wrapper}>
          ...
          <FeatureLargeImageExternalLinkCard href="https://roadmap.sh/ux-design" iconSrc='images/books/roadmap.sh.png' title='Roadmap Ux-Design' subtitle="Пошаговый гайд для UX дизайнер в 2025 года" />
          <FeatureLargeImageExternalLinkCard href="https://roadmap.sh/design-system" iconSrc='images/books/roadmap.sh.png' title='Roadmap Design System' subtitle="Как создать дизайн-систему" />
