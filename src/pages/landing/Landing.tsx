      ...
      <Section>
        ...
        <Section sublevel={2}>
          <Heading muted size={4} kind='thin' className={classNames(Styles.heading)}>
            Разрабатывал интерфейсы приложений кибербезопасности (rdp protocol), образовательных платформ, строительных компаний, терминалов сбора данных промышленных предприятий, международного оператора доставки грузов, закрытых систем для управляющих жилыми домами компаний (далее УК) со встроенным умным домом, систем обработки заявок УК, систем учёта общедомовых, коммерческих и частных объектов имущества, систем видеонаблюдения с искуственным интеллектом, системы учёта пассажиров для аэропорта, лендингов, информационных сайтов.
          </Heading>
          <Heading muted size={4} kind='thin' className={classNames(Styles.heading)}>
